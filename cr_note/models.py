...
class Crn(models.Model):
    ...
    cr_cash = models.DecimalField(max_digits=20, decimal_places=2, null=True)
    # amount_in_words = models.CharField(max_length=1000, null=True)
    cr_status = models.CharField(max_length=1000, default='Delivered', editable=True)
